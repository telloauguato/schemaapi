        ...
        <div className="container mx-auto flex flex-wrap px-5 py-24">
          <div className="-mx-4 mb-auto mt-auto flex flex-wrap content-start sm:w-2/3 sm:pr-10 lg:w-1/2">
            <div className="mb-6 w-full px-4 sm:p-4">
              <h1 className="title-font mb-2 text-xl font-medium text-gray-900">Moon hashtag pop-up try-hard offal truffaut</h1>
            ...
            <div className="w-1/2 p-4 sm:w-1/2 lg:w-1/4">
              <h2 className="title-font text-3xl font-medium text-gray-900">2.7K</h2>
              <p className="leading-relaxed">Users</p>
            </div>
            <div className="w-1/2 p-4 sm:w-1/2 lg:w-1/4">
              <h2 className="title-font text-3xl font-medium text-gray-900">1.8K</h2>
              <p className="leading-relaxed">Subscribes</p>
            </div>
            <div className="w-1/2 p-4 sm:w-1/2 lg:w-1/4">
              <h2 className="title-font text-3xl font-medium text-gray-900">35</h2>
              <p className="leading-relaxed">Downloads</p>
            </div>
            <div className="w-1/2 p-4 sm:w-1/2 lg:w-1/4">
              <h2 className="title-font text-3xl font-medium text-gray-900">4</h2>
